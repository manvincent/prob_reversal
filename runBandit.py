...
def saveData(sI, expInfo, dispInfo, taskInfo, taskObj, keyInfo):
    ...
    if not os.path.exists(ancOutDir):
        os.mkdir(ancOutDir)
    save_obj(expInfo, ancOutDir + os.sep + 'sub' + str(expInfo.SubNo) + '_sess' + str(sI+1) + '_expInfo')
    save_obj(dispInfo, ancOutDir + os.sep + 'sub' + str(expInfo.SubNo) + '_sess' + str(sI+1) + '_dispInfo')
    save_obj(keyInfo, ancOutDir + os.sep + 'sub' + str(expInfo.SubNo) + '_sess' + str(sI+1) + '_keyInfo')
    # Save data
    save_obj(taskInfo, expInfo.outDir + os.sep + 'sub' + str(expInfo.SubNo) + '_sess' + str(sI+1) + '_data')
    return
